...
var passwordResponse = document.getElementById('password-response');

/****** PASSWORD HIDE/SHOW TOGGLE VARIABLES ******/

var toggleShowOrHidePWD = document.querySelector('#password-show-or-hide-section');
var passwordState = false;
var hideOrShowIcon = document.querySelector('.fa-eye');
...
toggleShowOrHidePWD.addEventListener('click', function () {
  if (passwordState) {
